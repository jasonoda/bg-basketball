...
export default class Engine{
    ...
    update(){
        ...
        if (currentTime - this.fpsTime > 1000) {
            ...
            document.getElementById("feedback").innerHTML = this.fps;
            this.frameCount = 0;
        ...
        if(this.action==="set up"){
            ...
            this.scene3D.fog = new THREE.Fog(0x07001e, 10, 60);
            ...
            this.camContY.position.y=2.4

            var geometry = new THREE.BoxGeometry();
            var material = new THREE.MeshStandardMaterial({ color: 0x00ff00, visible: false });
            this.startBox = new THREE.Mesh(geometry, material);
            this.startBox.scale.x = this.startBox.scale.y = this.startBox.scale.z = .02;
            this.startBox.scale.y = 22;
            this.startBox.position.z=7.4;
            this.camContY.add(this.startBox);
            
            // this.camera.position.z = 5;
            // this.camContY.rotation.y = this.u.ca(0)
